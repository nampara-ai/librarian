...
`v0.1.0a12` is the latest public alpha. It includes local CLI workflows, a FastAPI service,
...
pip install "nampara_librarian-0.1.0a12-py3-none-any.whl[all]"
```
...
docker run --rm -p 8080:8080 \
  ...
  ghcr.io/nampara-ai/librarian:v0.1.0a12
```
