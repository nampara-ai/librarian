...
CleaningPromptVersionSetting = Literal["cmos_v1", "cmos_v2", "cmos_v3", "cmos_v4", "cmos_v5"]
...
class Settings(BaseSettings):
    ...
    cleaning_prompt_version: CleaningPromptVersionSetting = Field(default="cmos_v5")
