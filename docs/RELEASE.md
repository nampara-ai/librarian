...
```
   ...
   throughput metrics; incomplete detail records are rejected. Eval aggregate summaries, including
   ...
   metrics; DOCX/table/header, embedded-text, and caption coverage tags are likewise checked
   against source paths and matching diagnostics. Benchmark aggregate summaries, including input size, chunk counts,
