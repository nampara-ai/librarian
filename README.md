...
`v0.1.0a63` is the latest public alpha. It includes local CLI workflows, a FastAPI service,
...
search/export with detailed result timestamps, release automation, OSS governance files, OCR
correction quality warnings, repeated-tail output validation, and an external capability review for
Dolphin, olmOCR, and LongCut upgrade paths.
...
docker run --rm -p 8080:8080 \
  ...
  ghcr.io/nampara-ai/librarian:v0.1.0a63
```
