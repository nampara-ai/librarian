...
4. A short descriptive title for the document: 3 to 8 words in title case, specific to this
...
5. Between 3 and 7 topical tags: short lowercase phrases naming the document's subjects.
...
over incidental examples, names, or metaphors. The title must describe this specific document, not
just its category.
